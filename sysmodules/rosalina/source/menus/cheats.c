...
void RosalinaMenu_Cheats(void)
{
    ...
    if (titleId == 0 || cheatCount == 0)
    {
        do
        {
            ...
            if (titleId == 0)
            {
                Draw_DrawString(10, 30, COLOR_WHITE, "No se ha encontrado titulo adecuado");
            }
            else
            {
                Draw_DrawFormattedString(10, 30, COLOR_WHITE, "No se han encontrado trucos para el titulo %016llX", titleId);
            }
